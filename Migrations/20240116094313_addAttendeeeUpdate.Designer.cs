...
namespace RecordMedical.Migrations
{
    ...
    [Migration("20240116094313_addAttendeeeUpdate")]
    partial class addAttendeeeUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecordMedical.Model.Attendee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RecordMedical.Model.User", b =>
                {
                    ...
                    b.Property<long>("PasswordManagerId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("RecordMedical.Model.Patient", b =>
                {
                    ...
                    b.HasOne("RecordMedical.Model.Attendee", "Attendee")
                        .WithMany()
            ...
            modelBuilder.Entity("RecordMedical.Model.User", b =>
                {
                    b.HasOne("RecordMedical.Model.PasswordManager", "PasswordManager")
                        .WithMany()
                        .HasForeignKey("PasswordManagerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
